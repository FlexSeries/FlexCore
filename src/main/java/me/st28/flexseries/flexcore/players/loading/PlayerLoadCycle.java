...
public final class PlayerLoadCycle {
    ...
    /**
     * Utility method for ending a cycle due to a {@link me.st28.flexseries.flexcore.players.loading.PlayerLoader} failing.
     *
    ...
    /**
     * Utility method for marking a {@link me.st28.flexseries.flexcore.players.loading.PlayerLoader} as complete in a given cycle.
     *
     * @param cycle The load cycle instance.
    ...
    /**
     * Registers a {@link me.st28.flexseries.flexcore.players.loading.PlayerLoader}.
     *
    ...
    /**
     * @return True if all of the {@link me.st28.flexseries.flexcore.players.loading.PlayerLoader}s have completed loading for a given player.<br />
    ...
    /**
     * Attempts to start a specified {@link me.st28.flexseries.flexcore.players.loading.PlayerLoader}.
     *
