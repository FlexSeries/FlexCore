package me.st28.flexseries.flexcore.backend.commands.terms;
...
public final class SCmdTermsDecline extends FlexCommand<FlexCore> {

    public SCmdTermsDecline(FlexCore plugin, FlexCommand<FlexCore> parent) {
        super(
                plugin,
                new String[]{"decline"},
                parent,
                new FlexCommandSettings<FlexCore>()
                        .description("Decline Terms of Use")
